...
export interface OfficerAction {
    type: "set-zone" | "set-incident" | "request-backup" | "clear-backup" | "start-lockdown" | "end-lockdown" | "unit-check";
    value?: string | boolean;
}
export interface AdminCommand {
    type: "set-mode" | "clear-incident" | "broadcast" | "clear-events" | "reset-system";
    value?: string;
}
